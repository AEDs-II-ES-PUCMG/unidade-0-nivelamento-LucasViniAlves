    ...
    */
    ...
    static Produto[] lerProdutos(String nomeArquivoDados) {
        ...
        try {
            ...
            quantosProdutos = 0;
            while (leitorArquivo.hasNextLine() && quantosProdutos < quantidade) {
            ...
            System.out.println("Arquivo de dados não encontrado. Um novo cadastro será iniciado.");
	...
	static void localizarProdutos(){
		...
		for (int i = 0; i < quantosProdutos; i++) {
			if (produtosCadastrados[i] != null &&
				produtosCadastrados[i].getDescricao().equalsIgnoreCase(descricao)) {
				System.out.println("\nProduto encontrado:");
    ...
    static void cadastrarProduto(){
        ...
        try {
            ...
            double precoDeCusto = Double.parseDouble(teclado.nextLine().replace(",", "."));

            System.out.print("Margem de lucro: ");
            double margemDeLucro = Double.parseDouble(teclado.nextLine().replace(",", "."));
